    ...
    <div className='w-full'>
      <div className='w-screen h-[50vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>Next Dashboard</h2>
          <h3>Next JS / Tailwind / Json Server / Fake Store API</h3>
        </div>
      </div>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <p>
            ...
            This is a mobile responsive recreation of Admin Dashboard and features
            Next/Json Server to Using Real Data From Fake Store API to Fetch These Data in Page.
          </p>
          <a
            href='https://next-admin-dashboard-seven.vercel.app/'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            href='https://github.com/Emababy/next-admin-dashboard'
            target='_blank'
            rel='noreferrer'
          >
